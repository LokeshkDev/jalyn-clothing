...
import { ChevronUp, ChevronDown, Heart, Maximize2, ZoomIn } from 'lucide-react'
...
export default function ProductGallery({ product, images = [] }) {
  ...
  const currentImage = images[selectedIndex] || product.images.primary
      ...
      <div className="flex flex-col items-center gap-2">
        {images.length > 4 && (
          <button
            ...
            className="flex h-7 w-7 items-center justify-center rounded-full bg-white text-ink-muted shadow-sm hover:text-primary border border-primary/10"
          >
            <ChevronUp className="h-4 w-4" />
          </button>
        )}

        <div className="flex flex-col gap-3 overflow-y-auto max-h-[560px] scrollbar-none py-1">
