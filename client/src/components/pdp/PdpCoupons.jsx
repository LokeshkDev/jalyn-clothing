...
export default function PdpCoupons() {
  ...
  return (
    <section>
      ...
      >
        {coupons.map((cp) => {
          const hasOffStr = cp.discountLabel?.toUpperCase().includes('OFF')
          const displayDiscount = hasOffStr ? cp.discountLabel : `${cp.discountLabel} OFF`
          return (
              ...
              >
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-1 text-red-600 font-bold text-[10px]">
                    ...
                    <span className="truncate text-red-700 font-extrabold">
                      {displayDiscount}
                    </span>
                  </div>
