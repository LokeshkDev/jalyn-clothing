  ...
  const loadData = async () => {
    ...
    try {
      const [prodRes, cmsRes] = await Promise.all([
        api.get('/products', { params: { new_arrivals: '1', sort: sortOption } }),
      ...
      >
        ...
        <div className="relative z-10 container-luxury max-w-7xl px-0 sm:px-6 w-full space-y-3">
          ...
          <div className="max-w-2xl">
            <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-rose-blush mb-1 block">Fresh Drops</span>
