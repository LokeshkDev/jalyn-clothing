...
export const SHOP_PRODUCTS = [
  {
    ...
    variants: [
      { color: 'rose', size: 'XS', stock: 5 },
      { color: 'rose', size: 'S', stock: 8 },
      { color: 'rose', size: 'M', stock: 10 },
      { color: 'rose', size: 'L', stock: 4 },
      { color: 'rose', size: 'XL', stock: 0 },
      { color: 'cream', size: 'XS', stock: 0 },
      { color: 'cream', size: 'S', stock: 6 },
      { color: 'cream', size: 'M', stock: 8 },
      { color: 'cream', size: 'L', stock: 5 },
      { color: 'cream', size: 'XL', stock: 0 },
      { color: 'cream', size: 'XXL', stock: 0 },
      { color: 'black', size: 'XS', stock: 2 },
